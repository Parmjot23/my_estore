  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px] mt-7.5">
      ...
      >
        ...
        <svg
          className={`fill-current ease-out duration-200 hover:border-blue ${
            dropdown && "rotate-180"
          }`}
          width="22"
          height="22"
      ...
      <div className={`p-4 sm:p-8.5 ${dropdown ? "block" : "hidden"}`}>
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-gray-1 rounded-md border border-gray-3 text-dark-4 py-3 pl-5 pr-9 duration-200 hover:border-blue appearance-none outline-none focus:border-blue focus:shadow-input focus:ring-2 focus:ring-blue/20">
