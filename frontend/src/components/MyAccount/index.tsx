  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .form-input {
          @apply block w-full px-4 py-3 text-sm text-dark dark:text-white bg-white dark:bg-dark-input border border-gray-300 dark:border-dark-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue focus:border-blue transition-colors placeholder-gray-400 dark:placeholder-gray-500;
        }
